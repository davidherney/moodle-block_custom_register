...
/**
 * Strings for component 'block_custom_register', language 'en', branch 'MOODLE_31_STABLE'
 *
...
$string['allregistersdeleted'] = 'Todos los registros fueron eliminados';
...
$string['custom_register:deleteregisters'] = 'Eliminar registros del reporte';
...
$string['deleteallregisters'] = 'Eliminar todos los registros';
$string['deleteregister'] = 'Eliminar';
$string['deleteselectedregisters'] = 'Eliminar seleccionados';
...
$string['registerdeleted'] = 'El registro fue eliminado';
...
$string['selectallregisters'] = 'Seleccionar todos los registros de esta página';
$string['selectedregistersdeleted'] = 'Se eliminaron {$a} registros seleccionados';
$string['selectregister'] = 'Seleccionar este registro';
$string['timecreated'] = 'Fecha';
$string['totalregisters'] = 'Total de registros: {$a}';
