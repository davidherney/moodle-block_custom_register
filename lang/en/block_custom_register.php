...
$string['allregistersdeleted'] = 'All entries were deleted';
...
$string['custom_register:deleteregisters'] = 'Delete register report entries';
...
$string['deleteallregisters'] = 'Delete all entries';
$string['deleteregister'] = 'Delete';
$string['deleteselectedregisters'] = 'Delete selected';
...
$string['noselectedregisters'] = 'Select at least one entry to delete';
...
$string['registerdeleted'] = 'The entry was deleted';
$string['relationedempty'] = 'The field {$a} is required';
$string['save'] = 'Save';
$string['saved'] = 'The information was saved';
$string['selectallregisters'] = 'Select all entries on this page';
$string['selectedregistersdeleted'] = '{$a} selected entries were deleted';
$string['selectregister'] = 'Select this entry';
$string['timecreated'] = 'Time';
$string['totalregisters'] = 'Total entries: {$a}';
